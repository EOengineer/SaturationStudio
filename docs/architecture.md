...
Default: **Diode / Silicon** — feedback soft-clipper with Drive→`Rin` (see `docs/models/diode.md`). Tube / Tape / Transformer / Preamp remain ADAA waveshapers (`docs/models/*.md`).
