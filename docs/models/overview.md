...
| **Tube** | Smooth transfer, even harmonics, eventual triode stages | Triode-ish ADAA waveshape; flavors 12AX7 / 5751 / 12AU7 (mu feel); `TubeDevice` Koren part on the shelf |
...
6c. One common-cathode Newton stage that stamps `TubeDevice` — later (first circuit consumer)  
