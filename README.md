...
- **Diode** model: Shockley `DiodeDevice` + ideal-OA feedback clipper, Drive/makeup, Si/Ge/LED/Asym flavors
...
| [`docs/models/diode.md`](docs/models/diode.md) | Shockley diode + feedback OA clipper |
